...
interface CustomElement extends TextStyle {
    ...
    fillColor?: string; // Similar to color but specific naming for shapes usually, but we can reuse 'color' or use 'fillColor'
}
...
const App = () => {
  ...
  const [profileConfig, setProfileConfig] = useState<ProfileConfig>({
      borderColor: '#ffffff',
      borderWidth: 4,
      borderRadius: 2, // Slightly rounded default
      scale: 1,
      yOffset: 0,
  });
  ...
  // Inspector Dragging State - start with null to use CSS default positioning
  ...
  const handleCropSave = (croppedImage: string) => {
      if (activeCropId === 'profile') {
          setImages(prev => ({ ...prev, profile: croppedImage }));
      } else if (activeCropId) {
          updateCustomElement(activeCropId, { src: croppedImage });
      }
                ...
                <div className="space-y-4">
                    ...
                    {(selectedStyle as CustomElement).type === 'image' && (
                        <button 
                            ...
                            className="w-full py-1.5 border border-gray-300 rounded text-xs font-medium hover:bg-gray-50 flex items-center justify-center gap-2 mb-2"
                        >
                            <CropIcon /> Crop Image
                        </button>
                    )}
                    ...
                    <div>
                        ...
                        <div className="flex gap-6 items-center">
                            <div className="w-24 h-28 bg-gray-100 rounded border border-gray-200 overflow-hidden flex-shrink-0 relative group">
                                ...
                                <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer" onClick={handleOpenCropper}><CropIcon className="text-white" /></div>
                            </div>
                            <div className="space-y-3">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={handleOpenCropper} className="px-4 py-2 border-0 text-xs font-medium hover:text-blue-600 flex items-center gap-2 text-gray-600"><CropIcon /> Adjust Photo</button>
                ...
                <div className="flex flex-col items-center gap-8 overflow-hidden bg-gray-50 p-8 rounded-xl inner-shadow border border-gray-100 relative" style={{ minHeight: '600px'}}>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="relative group shadow-2xl transition-transform duration-200 bg-white" style={{ width: '320px', height: '500px', transform: `scale(${zoom/100})`, transformOrigin: 'top center' }}>
                            ...
                            <div className="absolute inset-0 flex flex-col items-center pt-5 text-center p-4 z-20">
                                ...
                                {/* Custom Elements Rendering with Handles - FRONT */}
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="relative group shadow-2xl transition-transform duration-200 bg-white" style={{ width: '320px', height: '500px', transform: `scale(${zoom/100})`, transformOrigin: 'top center' }}>
                            ...
                            {/* Custom Elements Rendering with Handles - BACK */}
